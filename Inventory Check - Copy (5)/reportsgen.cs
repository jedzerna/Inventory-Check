    ...
    public partial class reportsgen : Form
    {
        ...
        private void color()
        {
            if (Properties.Settings.Default.color == "true")
            {
                ...
                guna2ComboBox3.FillColor = Color.FromArgb(36, 37, 37);
                guna2ComboBox2.FillColor = Color.FromArgb(36, 37, 37);
                guna2ComboBox1.FillColor = Color.FromArgb(36, 37, 37);
            ...
            else
            {
                ...
                guna2Panel4.FillColor = Color.FromArgb(243, 243, 243);
                guna2Panel3.FillColor = Color.FromArgb(243, 243, 243);


                cmSV.FillColor = Color.FromArgb(243, 243, 243);
                cmSV.ItemsAppearance.BackColor = Color.White;
                cmSV.ItemsAppearance.ForeColor = Color.Black;

                datetime1.FillColor = Color.FromArgb(243, 243, 243);
                datetime2.FillColor = Color.FromArgb(243, 243, 243);
                cmSV.ForeColor = Color.Black;
                datetime1.ForeColor = Color.Black;
                datetime2.ForeColor = Color.Black;
                ...
                guna2DateTimePicker1.BackColor = Color.FromArgb(243, 243, 243);
                guna2DateTimePicker2.BackColor = Color.FromArgb(243, 243, 243);
