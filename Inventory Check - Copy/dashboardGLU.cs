...
namespace Inventory_Check
{
    public partial class dashboardGLU : Form
    {
        ...
        private void dashboardGLU_Load(object sender, EventArgs e)
        {
            ...
            guna2Button3.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button4.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button5.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button6.FillColor = Color.FromArgb(56, 163, 255);
            guna2Button7.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button8.FillColor = Color.FromArgb(64, 64, 64);
        ...
        private void label1_Click_1(object sender, EventArgs e)
        {
            ...
            guna2Button4.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button5.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button6.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button8.FillColor = Color.FromArgb(64, 64, 64);
            guna2Button7.FillColor = Color.FromArgb(64, 64, 64);
