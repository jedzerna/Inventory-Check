        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
                {
                    ...
                    codeMaterial.Open();
                    string insStmt = "insert into tblHistory ([itemid], [date], [operation], [product_code], [description], [name], [remarks], [aqty], [stock]) values" +
                        " (@itemid,@date,@operation,@product_code,@description,@name,@remarks,@aqty,@stock)";
