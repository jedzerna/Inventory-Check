        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
                {
                    ...
                    check_User_Name.Parameters.AddWithValue("@description", guna2TextBox1.Text);
                ...
                else
                {
                    ...
                    using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
                    {
                        ...
                        codeMaterial.Close();
                         ...
                         fpcode = guna2TextBox4.Text +"-"+ ids.ToString();
                        ...
                        insCmd2.Parameters.AddWithValue("@description", "Added " + guna2TextBox1.Text.Replace("[", lb).Replace("]", rb).Replace("​*", "[*​]").Replace("%", "[%]").Replace("'", "''"));
                    ...
                    if (forms == "FORM1")
                    {
                        ...
                        dt.Rows.Add(ids, guna2TextBox4.Text + ids.ToString(), " ", guna2NumericUpDown2.Text, guna2TextBox1.Text, guna2NumericUpDown1.Text, guna2NumericUpDown3.Text, guna2TextBox3.Text, guna2ComboBox3.Text);
