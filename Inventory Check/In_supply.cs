    ...
    public partial class In_supply : Form
    {
        ...
        public void load()
        {
            ...
            using (SqlConnection itemCode = new SqlConnection(ConfigurationManager.ConnectionStrings["itemCode"].ConnectionString))
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    dataGridView1.Rows[n].Cells["ten"].Value = string.Format("{0:#,##0.00}",item["cost"].ToString());
                    dataGridView1.Rows[n].Cells["eleven"].Value = item["selling"];
                    dataGridView1.Rows[n].Cells["twelve"].Value = item["discount"];
                    dataGridView1.Rows[n].Cells["thirteen"].Value = string.Format("{0:#,##0.00}", item["total"].ToString());
        ...
        public void getinfo()
        {
            ...
            using (SqlConnection tblIn = new SqlConnection(ConfigurationManager.ConnectionStrings["tblIn"].ConnectionString))
            {
                ...
                if (rdr.Read())
                {
                    ...
                    {
                        label8.Text = DateTime.Parse(rdr["dateentered"].ToString()).ToString("MM/dd/yyyy");
                    }
        ...
        public void loadINVOICE()
        {
            ...
            using (SqlConnection itemCode = new SqlConnection(ConfigurationManager.ConnectionStrings["itemCode"].ConnectionString))
            {
                itemCode.Open();
                DataTable dt = new DataTable();
                string list = "Select productcode,description,qty,unit,Id,iitem,stocksleft,cost,selling,total,icode,si,charging from tblSIitems where poid = '" + id + "' order by sortingid ASC";
            ...
            {
                sum += Convert.ToDecimal(row.Cells["dataGridViewTextBoxColumn13"].Value.ToString());
            }
            guna2TextBox5.Text = string.Format("{0:#,##0.00}", sum);
        }
        public void notbalancae()
        {
            if (founderror == false)
            {
                if (lo == false)
                {
                    if (string.Format("{0:#,##0.00}", Convert.ToDecimal(dbamount)) != guna2TextBox4.Text)
                    {
                        //var tblIn = new SqlConnection(ConfigurationManager.ConnectionStrings["tblIn"].ConnectionString);
                        using (SqlConnection tblIn = new SqlConnection(ConfigurationManager.ConnectionStrings["tblIn"].ConnectionString))
                        {
                            MessageBox.Show("The system found imbalance amount.");
                            ...
                            if (dataGridView4.Rows.Count != 0)
                            {
                                ...
                                {
                                    if (dataGridView4.Rows[i].Cells["disid"].Value == null || dataGridView4.Rows[i].Cells["disid"].Value == DBNull.Value || String.IsNullOrWhiteSpace(dataGridView4.Rows[i].Cells["disid"].Value.ToString()))
                                    {
                                    }
                                    else
                                    {
                                        if (dataGridView4.Rows[i].Cells["type"].Value == null || dataGridView4.Rows[i].Cells["type"].Value == DBNull.Value || String.IsNullOrWhiteSpace(dataGridView4.Rows[i].Cells["type"].Value.ToString()))
                                        {
                                        }
                                        else
                                        {
                                            if (dataGridView4.Rows[i].Cells["remarks1"].Value == null || dataGridView4.Rows[i].Cells["remarks1"].Value == DBNull.Value || String.IsNullOrWhiteSpace(dataGridView4.Rows[i].Cells["remarks1"].Value.ToString()))
                                            {
                                            }
                                            else
                                            {
                                                ...
                                                {
                                                    insCmd2.Parameters.AddWithValue("@remarks", "");
                                                }
                            ...
                            else
                            {
                                foreach (DataGridViewRow row in dataGridView1.Rows)
                                {
                                    ...
                                    {
                                        itemCode.Open();
                                        string insStmt2 = "update itemCode set total=@total where Id=@Id";

                                        SqlCommand insCmd2 = new SqlCommand(insStmt2, itemCode);
                                        insCmd2.Parameters.AddWithValue("@Id", row.Cells["six"].Value.ToString());
                                        insCmd2.Parameters.AddWithValue("@total", row.Cells["thirteen"].Value.ToString());
                                        insCmd2.ExecuteNonQuery();
                                        itemCode.Close();
                                    }
                                }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Columns["delete"].Visible == true)
            {
                    ...
                    e.RowIndex >= 0)
                {
                    ...
                    else
                    {
                        ...
                        a.itempoid = dataGridView1.CurrentRow.Cells["six"].Value.ToString();
                        a.iitem = dataGridView1.CurrentRow.Cells["eight"].Value.ToString();
                        a.itemstocks = dataGridView1.CurrentRow.Cells["four"].Value.ToString();
                        a.name = name;
            ...
            //if (dataGridView1.Columns["delete"].Visible == false)
            //{
            //    var senderGrid = (DataGridView)sender;
            //    if (senderGrid.Columns[e.ColumnIndex] is DataGridViewButtonColumn &&
            //        e.RowIndex >= 0)
            //    {
            //        MessageBox.Show(dataGridView1.CurrentRow.Cells["one"].Value.ToString());
            //    }
            //}
            ...
            if (lo == false)
            {
                ...
                if (dataGridView1.Rows.Count != 0)
                {
                    ...
                    foreach (DataGridViewRow rows in dataGridView1.Rows)
                    {
                        ...
                        decimal totalamount = Convert.ToDecimal(rows.Cells["four"].Value) * Convert.ToDecimal(rows.Cells["ten"].Value);
                        
                        sumqty += Convert.ToDecimal(rows.Cells["four"].Value);
                        totalsum += totalamount;
                        rows.Cells["thirteen"].Value = string.Format("{0:#,##0.00}", totalamount);
                    }
                    //MessageBox.Show("6");
                    ...
                    {
                        //MessageBox.Show("7");
                        if (label38.Text != "FALSE" || label38.Text != "0.00" || label41.Text != "0.00")
                        {
        ...
        public void update()
        {
            ...
            else
            {
                foreach(DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    {
                        codeMaterial.Open();
                        String query = "SELECT * FROM codeMaterial WHERE ID = '" + row.Cells["eight"].Value.ToString() + "'";
                    ...
                    if (found == true)
                    {
                        ...
                        sum2 += Convert.ToDouble(stocks.ToString()) + Convert.ToDouble(row.Cells["four"].Value);
                        ...
                        using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
                        {
                            ...
                            codeMaterial.Open();
                            cmd.Parameters.AddWithValue("@ID", row.Cells["eight"].Value.ToString());
                            cmd.Parameters.AddWithValue("@stocksleft", sum2);
                            cmd.ExecuteNonQuery();
                            codeMaterial.Close();
                        ...
                        {
                            string p = "PO";
                            SqlCommand cmd4 = new SqlCommand("update itemCode set typeofp=@typeofp,poid=@poid,stocksleft=@stocksleft where Id=@Id", itemCode);
                            itemCode.Open();
                            cmd4.Parameters.AddWithValue("@Id", row.Cells["six"].Value.ToString());
                            cmd4.Parameters.AddWithValue("@typeofp", p);
                            cmd4.Parameters.AddWithValue("@poid", id);
                            cmd4.Parameters.AddWithValue("@stocksleft", sum2);
        ...
        {
            //MessageBox.Show(operationcheck);
            if (operationcheck == "Completed")
            {
                if (dataGridView1.Rows.Count == 1 || dataGridView1.Rows.Count == 0)
                {
                    MessageBox.Show("Can't delete if only one item left.");
                }else
                {
        ...
        {
            MessageBox.Show("This feature still not available, please wait for the next update, thank you.");
            return;
            ...
            if (dataGridView1.Columns["delete"].Visible == false)
            {
                ...
                {
                    MessageBox.Show("Incompleted PO still not available for this feature, please wait for the next update, thank you.");
                }
            }
            else
            {
                MessageBox.Show("You are in the edit mode.");
            }
        }
