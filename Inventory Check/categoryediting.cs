    ...
    public partial class categoryediting : Form
    {
        ...
        private void color()
        {
            if (Properties.Settings.Default.color == "true")
            {
                ...
                dataGridView4.BackgroundColor = Color.FromArgb(15, 14, 15);
                dataGridView4.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(15, 14, 15);
                dataGridView4.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                dataGridView4.RowsDefaultCellStyle.BackColor = Color.FromArgb(15, 14, 15);
            ...
            else
            {
                ...
                dataGridView4.BackgroundColor = Color.FromArgb(224, 224, 224);
                dataGridView4.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(224, 224, 224);
                dataGridView4.ColumnHeadersDefaultCellStyle.ForeColor = Color.Black;
                dataGridView4.RowsDefaultCellStyle.BackColor = Color.FromArgb(224, 224, 224);
        ...
        {
            if (dataGridView4.Rows.Count == 0 && label3.Text != "")
            {
                categoryDeletion c = new categoryDeletion();

                c.vcat = dataGridView3.CurrentRow.Cells["Column2"].Value.ToString();
                c.cat = dataGridView3.CurrentRow.Cells["Column1"].Value.ToString();
                if (dataGridView1.Rows.Count != 0)
                {
                    c.subcat = dataGridView1.CurrentRow.Cells["Column3"].Value.ToString();
                    c.vsubcat = dataGridView1.CurrentRow.Cells["Column4"].Value.ToString();
                }
                else
                {
                    c.subcat = "";
                ...
                if (dataGridView2.Rows.Count != 0)
                {
                    c.vtype = dataGridView2.CurrentRow.Cells["Column6"].Value.ToString();
                    c.type = dataGridView2.CurrentRow.Cells["Column5"].Value.ToString();
                }
                else
                {
                    c.vtype = "";
            ...
            {
                MessageBox.Show("You cannot delete this data if there is still registered item in it. Please move the registered items to continue.");
            }
        }
    }
}
