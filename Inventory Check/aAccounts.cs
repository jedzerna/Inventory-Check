    ...
    public partial class aAccounts : Form
    {
        ...
        private void color()
        {
            ...
            else
            {
                ...
                guna2Panel1.FillColor = Color.FromArgb(1, 115, 1);

                dataGridView2.BackgroundColor = Color.FromArgb(1, 115, 1);
                dataGridView2.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(1, 115, 1);
                dataGridView2.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                dataGridView2.RowsDefaultCellStyle.BackColor = Color.FromArgb(1, 115, 1);
                dataGridView2.RowsDefaultCellStyle.ForeColor = Color.White;
                dataGridView2.GridColor = Color.FromArgb(1, 115, 1);
