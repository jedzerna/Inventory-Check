                ...
                if (guna2TextBox3.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
                        {
                            ...
                            codeMaterial.Open();
                            string insStmt = "insert into tblHistory ([itemid], [date], [operation], [product_code], [description], [name],[remarks], [dqty],[stock],[type]) values" +
                                " (@itemid,@date,@operation,@product_code,@description,@name,@remarks,@dqty,@stock,@type)";
                            ...
                            insCmd.Parameters.AddWithValue("@type", "DD");
