    ...
    public partial class allhistory : Form
    {
        ...
        private void color()
        {
            if (Properties.Settings.Default.color == "true")
            {
                ...
                guna2TextBox8.FillColor = Color.FromArgb(56, 56, 57);
            ...
            else
            {
                ...
                dataGridView1.RowsDefaultCellStyle.BackColor = Color.FromArgb(243, 243, 243);
                dataGridView1.RowsDefaultCellStyle.ForeColor = Color.Black;

                guna2TextBox8.FillColor = Color.FromArgb(226, 226, 227);
        ...
        {
            if (dataGridView1.CurrentRow.Cells["operation"].Value.ToString().Contains("Deleted || ") == false)
            {
