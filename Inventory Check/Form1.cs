    ...
    public partial class Form1 : Form
    {
        ...
        public void count()
        {
            ...
            if (dataGridView1.Rows.Count != 0)
            {
                ...
                dataGridView1.CurrentRow.Cells[5].Value = string.Format("{0:#,##0.00}", sum4);

                double final = 0.00;
                final += sum2 - sum2 * Convert.ToDouble(dataGridView1.CurrentRow.Cells[7].Value);
                dataGridView1.CurrentRow.Cells[10].Value = string.Format("{0:#,##0.00}", final);
     ...
     && e.KeyChar != '.')
        ...
        public void addition()
        {
            using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
            {
                ...
                codeMaterial.Open();
                string listA = "Select ID,product_code,mfg_code,stocksleft,description,cost,selling,unit,dept from codeMaterial WHERE ID BETWEEN '" + idindt + "' AND '" + maxId + "'";
                ...
                foreach (DataRow rows in dat.Rows)
                {
                    ...
                    if (check != 1)
                    {
                        ...
                        newRow[2] = rows["mfg_code"].ToString();
                        newRow[3] = rows["stocksleft"].ToString();
                        newRow[4] = rows["description"].ToString();
                        newRow[5] = rows["cost"].ToString();
                        newRow[6] = rows["selling"].ToString();
                        newRow[7] = rows["unit"].ToString();
                        newRow[8] = rows["dept"].ToString();
        ...
        {
            int n = dataGridView1.Rows.Add();
            dataGridView1.Rows[n].Cells[1].Value = dataGridView3.SelectedCells[1].Value;
            dataGridView1.Rows[n].Cells[2].Value = dataGridView3.SelectedCells[2].Value;
            dataGridView1.Rows[n].Cells[3].Value = dataGridView3.SelectedCells[4].Value;
            dataGridView1.Rows[n].Cells[4].Value = dataGridView3.SelectedCells[0].Value;
            dataGridView1.Rows[n].Cells[5].Value = "0.00";
            dataGridView1.Rows[n].Cells[6].Value = dataGridView3.SelectedCells[7].Value;
            dataGridView1.Rows[n].Cells[7].Value = "0.00";
            dataGridView1.Rows[n].Cells[8].Value = dataGridView3.SelectedCells[5].Value;
            dataGridView1.Rows[n].Cells[9].Value = dataGridView3.SelectedCells[6].Value;
            dataGridView1.Rows[n].Cells[10].Value = "0.00";
            dataGridView1.Rows[n].Cells[11].Value = dataGridView3.SelectedCells[8].Value;

            using (SqlConnection codeMaterial = new SqlConnection(ConfigurationManager.ConnectionStrings["codeMaterial"].ConnectionString))
            {
                codeMaterial.Open();
                DataTable dt = new DataTable();
                String query = "SELECT stocksleft FROM codeMaterial WHERE ID = '" + dataGridView3.SelectedCells[0].Value.ToString() + "'";
                SqlCommand cmd = new SqlCommand(query, codeMaterial);
                SqlDataReader rdr = cmd.ExecuteReader();
