    ...
    public partial class uForm : Form
    {
        ...
        private void color()
        {
            if (Properties.Settings.Default.color == "true")
            {
                ...
                guna2ShadowPanel1.FillColor = Color.FromArgb(45, 44, 45);
                guna2ShadowPanel2.FillColor = Color.FromArgb(45, 44, 45);
                guna2ShadowPanel3.FillColor = Color.FromArgb(45, 44, 45);

                dataGridView3.BackgroundColor = Color.FromArgb(36, 37, 37);
                dataGridView3.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(36, 37, 37);
                dataGridView3.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                dataGridView3.RowsDefaultCellStyle.BackColor = Color.FromArgb(36, 37, 37);
            ...
            else
            {
                ...
                guna2TextBox1.FillColor = Color.FromArgb(243, 243, 243);
                guna2TextBox1.ForeColor = Color.Black;
                guna2TextBox2.FillColor = Color.FromArgb(243, 243, 243);
                guna2TextBox2.ForeColor = Color.Black;
                guna2TextBox3.FillColor = Color.FromArgb(243, 243, 243);
                guna2TextBox3.ForeColor = Color.Black;
                guna2TextBox5.FillColor = Color.FromArgb(243, 243, 243);
                guna2TextBox5.ForeColor = Color.Black;
                guna2TextBox4.FillColor = Color.FromArgb(243, 243, 243);
                guna2TextBox4.ForeColor = Color.Black;

                guna2ComboBox2.FillColor = Color.FromArgb(243, 243, 243);
