    ...
    public partial class DRForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
         ...
         private void save()
            ...
            {
                dbDR.Open();
                string insStmt = "insert into tblDR ([drnumber], [additionalinfo], [itemcode], [projectcode], [projectname], [datetime], [operation], [qty], [totalitems], [totalamount], [createdby], [sv], [dateentered]) values" +
                 " (@drnumber,@additionalinfo,@itemcode,@projectcode,@projectname,@datetime,@operation,@qty,@totalitems,@totalamount,@createdby,@sv,@dateentered)";
